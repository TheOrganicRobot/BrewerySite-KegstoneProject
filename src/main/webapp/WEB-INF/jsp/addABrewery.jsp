...
<%@ include file="/WEB-INF/jsp/header.jsp"%>
 ...
 <c:url var="addABreweryValidation" value="/js/addABrewery.validate.js" />
 <script src="${addABreweryValidation}"></script> 
...
<%-- 	<c:url var="addABreweryUrl" value="/addABrewery" />
 --%>
	<div class="brewery-form-container">
		...
		<form:form id="add-a-brewery" action="addABrewery" method="POST"
		modelAttribute="addABrewery">		 
		...
		<div class="row">
			...
			<div class="col-75">
				<form:input path="breweryName" placeholder="brewery name" /><br>
		...
		<div class="row">
    		...
    		<div class="col-75">
				<form:input path="address1" placeholder="address 1" /><br>
		...
		<div class="row">
			...
			<div class="col-75">
				<form:input path="address2" placeholder="address 2" /><br>
		...
		<div class="row">
			...
			<div class="col-75">
				...
				<option value="null" disabled="disabled" selected="selected">Select Your State</option>			
		...
		<div class="row">
			...
			<div class="col-75">
				<form:input path="phoneNumber" placeholder="ex. (123)456-7890" /><br>
		...
		<div class="row">
			...
			<div class="col-75">
				<form:input path="webAddress" placeholder="www.  ..." value="http://" /><br>
		...
		<div class="row">
			...
			<div class="col-75">
				<form:input path="breweryDescription" placeholder="enter a description" /><br>
